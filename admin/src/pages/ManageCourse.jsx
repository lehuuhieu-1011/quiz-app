...
function ManageCourse() {
    ...
    if (!state.login) {
      ...
      if (!CheckRoleToken('Admin')) {
        OpenNotification(
          'Permission',
          'error',
          'Your account dont have permission'
        );
        HandleLogout();
      }
    }
      ...
      render: (value) => (
        <Space size="middle">
          <Tag
            ...
            onClick={() => showDeleteConfirm(value.key)}
          >
            DELETE
          </Tag>
          <Tag
          ...
          <Tag
            ...
            onClick={() => {
              ...
              localStorage.setItem('CourseId', value.key);
              navigate('/waiting');
            }}
          >
            START
  ...
  const onChangeEditImage = (e) => {
    ...
    if (imageUrl) {
      document.querySelector('#basic > div .ant-space-item').style.display =
        'none';
    }
  };
        ...
        {loadingForm ? (
          ...
          >
            ...
            <Form.Item label="Image">
              <Space size={12}>
                {imageUrl && (
                  <img id="oldImage" src={imageUrl} alt="" width={100} />
                )}
                <div style={{ width: 300 }}>
                  <Upload
                    listType="picture"
